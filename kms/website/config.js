...
module.exports = 
{
  ...
  "bridges": [
    ...
    {"level": 0, "id": "plus", "selector": {"passthrough": true, "left": [{"marker": "number"}], "match": "same", "right": [{"marker": "number"}]}, "bridge": "{ ...next(operator), value: add(before, after), marker: before[0].marker }"},
    {"level": 0, "id": "conj", "selector": {"passthrough": true, "left": [{"variable": "v", "no_match": ["nameableConcept", "anyConcept"], "sentinals": ["number"]}], "match": "same", "right": [{"variable": "v", "sentinals": ["number"]}]}, "bridge": "{ ...next(operator), value: append(before, after) }"},
    {"level": 1, "id": "conj", "selector": {"left": [{"variable": "v", "sentinals": ["number"]}], "match": "same", "passthrough": true}, "bridge": "{ ...operator, value: append(before, operator.value) }"},
    ...
    {"level": 0, "id": "aEnglish", "selector": {"type": "prefix"}, "bridge": "{ ...after[0], number: 1 }"},
    {"level": 0, "id": "create", "selector": {"type": "prefix"}, "bridge": "{ klass: after[0], ...next(operator) }"},
