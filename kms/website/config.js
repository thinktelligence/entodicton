...
module.exports = 
{
  ...
  "bridges": [
    {"level": 0, "bridge": "{ ...after }", "id": "english"},
    {"level": 0, "bridge": "{ ...after }", "id": "french"},
    {"level": 0, "bridge": "{ ...after }", "id": "name"},
    {"level": 0, "bridge": "{ ...after }", "id": "nameableConcept"},
    {"level": 0, "bridge": "{ ...after[0], number: 'all' }", "id": "all"},
    {"level": 0, "bridge": "{ ...after[0], concept: true }", "id": "the"},
    {"level": 0, "bridge": "{ ...after[0], gender: 'f', concept: true }", "id": "la"},
    {"level": 0, "bridge": "{ marker: 'query', isQuery: true }", "id": "query"},
    {"level": 0, "bridge": "{ object: after[0], ...next(operator) }", "id": "property"},
    {"level": 1, "bridge": "{ value: objects.tanks[operator.object['id']][before[0].name], marker: operator(objects.types[before[0].name].id, objects.types[before[0].name].level), propertyName: before[0].name, object:operator.object.id, isProperty: true }", "id": "property"},
    {"level": 0, "bridge": "{ objects: after[0], ...next(operator) }", "id": "equal"},
    {"level": 1, "bridge": "{ ...next(operator), objects: append(before, [operator.objects]) }", "id": "equal"},
    {"selector": {"right": [{"marker": "number"}], "match": "same", "passthrough": true, "left": [{"marker": "number"}]}, "level": 0, "bridge": "{ ...next(operator), value: add(before, after), marker: before[0].marker }", "id": "plus"},
    {"selector": {"right": [{"variable": "v", "sentinals": ["number"]}], "match": "same", "passthrough": true, "left": [{"no_match": ["nameableConcept", "anyConcept"], "variable": "v", "sentinals": ["number"]}]}, "level": 0, "bridge": "{ ...next(operator), value: append(before, after) }", "id": "conj"},
    {"selector": {"match": "same", "passthrough": true, "left": [{"variable": "v", "sentinals": ["number"]}]}, "level": 1, "bridge": "{ ...operator, value: append(before, operator.value) }", "id": "conj"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "propertyConcept"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "tankConcept"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "buildingConcept"},
    {"level": 0, "bridge": "{ ...next(operator), destination: after[0] }", "id": "to"},
    {"level": 1, "bridge": "{ ...next(operator), thing: before[0] }", "id": "to"},
    {"level": 0, "bridge": "{ ...after[0], ...next(operator) }", "id": "move"},
    {"level": 1, "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.destination }", "id": "move"},
    {"level": 0, "bridge": "{ thing: after[0], ...next(operator) }", "id": "stop"},
    {"level": 1, "bridge": "{ action: 'stop', marker: 'stop', thing: operator.thing }", "id": "stop"},
    {"level": 0, "bridge": "{ ...next(operator), ...after }", "id": "position"},
    {"level": 0, "bridge": "{ ...next(operator), ...after }", "id": "number"},
    {"level": 0, "bridge": "{ ...operator, ...after[0], number: operator.value }", "id": "count"},
    {"selector": {"type": "prefix"}, "level": 0, "bridge": "{ ...after[0], number: 1 }", "id": "aEnglish"},
    {"selector": {"type": "prefix"}, "level": 0, "bridge": "{ klass: after[0], ...next(operator) }", "id": "create"},
    {"level": 1, "bridge": "{ action: 'create', marker: 'create', klass: operator.klass }", "id": "create"},
    {"level": 0, "bridge": "{ name: after[0], ...next(operator) }", "id": "destroy"},
    {"level": 1, "bridge": "{ action: 'destroy', marker: 'destroy', name: operator.name }", "id": "destroy"},
    {"level": 0, "bridge": "{ ...next(operator), thing: after[0], name: after[1] }", "id": "call"},
    {"level": 1, "bridge": "{ marker: 'alias', thing: operator.thing, name: operator.name }", "id": "call"},
    {"level": 0, "bridge": "{ ...next(operator), after: after[0], language: 'french' }", "id": "vers"},
    {"level": 0, "bridge": "{ ...next(operator), destination: after[0] }", "id": "aFrench"},
    {"level": 1, "bridge": "{ ...next(operator), thing: before[0] }", "id": "aFrench"},
    {"level": 0, "bridge": "{ ...squish(after), thing: after[0], ...next(operator), language: 'french' }", "id": "deplacez"},
    {"level": 1, "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.vers }", "id": "deplacez"},
    {"level": 0, "bridge": "{ place: after[0].destination, thing: after[0].thing, ...next(operator) }", "id": "bougez"},
    {"level": 1, "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.place }", "id": "bougez"},
    {"level": 0, "bridge": "{ ...next(operator), thing: after[0], name: after[1] }", "id": "appellez"},
    {"level": 1, "bridge": "{ marker: 'alias', thing: operator.thing, name: operator.name }", "id": "appellez"},
    {"level": 0, "bridge": "{ thing: after[0], ...next(operator) }", "id": "arreter"},
    {"level": 1, "bridge": "{ action: 'stop', marker: 'stop', thing: operator.thing }", "id": "arreter"},
    {"level": 0, "bridge": "{ name: after[0], ...next(operator) }", "id": "detruire"},
    {"level": 1, "bridge": "{ action: 'destroy', marker: 'destroy', name: operator.name }", "id": "detruire"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "anyConcept"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "week"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "dollarConcept"},
    {"level": 0, "bridge": "{ ...next(operator) }", "id": "personConcept"},
    {"level": 0, "bridge": "{ marker: 'dollarConcept', units: 'dollars', amount: before.value, duration: 'week' }", "id": "every"},
    {"level": 0, "bridge": "{ marker: 'earn', units: 'dollars', amount: after.amount, who: before.id, period: after.duration }", "id": "earn"},
    {"level": 0, "bridge": "{ marker: 'worked', who: before.id, duration: after.number, units: after.marker }", "id": "worked"},
