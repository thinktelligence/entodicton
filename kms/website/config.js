...
module.exports = 
{
  ...
  "bridges": [
    ...
    {"id": "all", "level": 0, "bridge": "{ ...after[0], number: 'all' }"},
    {"id": "the", "level": 0, "bridge": "{ ...after[0], concept: true }"},
    {"id": "la", "level": 0, "bridge": "{ ...after[0], gender: 'f', concept: true }"},
    ...
    {"id": "move", "level": 0, "bridge": "{ ...after[0], ...next(operator) }"},
    ...
    {"id": "count", "level": 0, "bridge": "{ ...operator, ...after[0], number: operator.value }"},
    {"id": "aEnglish", "level": 0, "selector": {"type": "prefix"}, "bridge": "{ ...after[0], number: 1 }"},
