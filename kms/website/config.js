...
module.exports = 
{
  ...
  "bridges": [
    {"level": 0, "id": "english", "bridge": "{ ...after }"},
    {"level": 0, "id": "french", "bridge": "{ ...after }"},
    {"level": 0, "id": "name", "bridge": "{ ...after }"},
    {"level": 0, "id": "nameableConcept", "bridge": "{ ...after }"},
    {"level": 0, "id": "all", "bridge": "{ ...after[0], number: 'all' }"},
    {"level": 0, "id": "the", "bridge": "{ ...after[0], concept: true }"},
    {"level": 0, "id": "la", "bridge": "{ ...after[0], gender: 'f', concept: true }"},
    {"level": 0, "id": "query", "bridge": "{ marker: 'query', isQuery: true }"},
    {"level": 0, "id": "property", "bridge": "{ object: after[0], ...next(operator) }"},
    {"level": 1, "id": "property", "bridge": "{ value: objects.tanks[operator.object['id']][before[0].name], marker: operator(objects.types[before[0].name].id, objects.types[before[0].name].level), propertyName: before[0].name, object:operator.object.id, isProperty: true }"},
    {"level": 0, "id": "equal", "bridge": "{ objects: after[0], ...next(operator) }"},
    {"level": 1, "id": "equal", "bridge": "{ ...next(operator), objects: append(before, [operator.objects]) }"},
    {"level": 0, "id": "plus", "bridge": "{ ...next(operator), value: add(before, after), marker: before[0].marker }", "selector": {"passthrough": true, "right": [{"marker": "number"}], "left": [{"marker": "number"}], "match": "same"}},
    {"level": 0, "id": "conj", "bridge": "{ ...next(operator), value: append(before, after) }", "selector": {"passthrough": true, "right": [{"sentinals": ["number"], "variable": "v"}], "left": [{"sentinals": ["number"], "variable": "v", "no_match": ["nameableConcept", "anyConcept"]}], "match": "same"}},
    {"level": 1, "id": "conj", "bridge": "{ ...operator, value: append(before, operator.value) }", "selector": {"passthrough": true, "left": [{"sentinals": ["number"], "variable": "v"}], "match": "same"}},
    {"level": 0, "id": "propertyConcept", "bridge": "{ ...next(operator) }"},
    {"level": 0, "id": "tankConcept", "bridge": "{ ...next(operator) }"},
    {"level": 0, "id": "buildingConcept", "bridge": "{ ...next(operator) }"},
    {"level": 0, "id": "to", "bridge": "{ ...next(operator), destination: after[0] }"},
    {"level": 1, "id": "to", "bridge": "{ ...next(operator), thing: before[0] }"},
    {"level": 0, "id": "move", "bridge": "{ ...after[0], ...next(operator) }"},
    {"level": 1, "id": "move", "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.destination }"},
    {"level": 0, "id": "stop", "bridge": "{ thing: after[0], ...next(operator) }"},
    {"level": 1, "id": "stop", "bridge": "{ action: 'stop', marker: 'stop', thing: operator.thing }"},
    {"level": 0, "id": "position", "bridge": "{ ...next(operator), ...after }"},
    {"level": 0, "id": "number", "bridge": "{ ...next(operator), ...after }"},
    {"level": 0, "id": "count", "bridge": "{ ...operator, ...after[0], number: operator.value }"},
    {"level": 0, "id": "aEnglish", "bridge": "{ ...after[0], number: 1 }", "selector": {"type": "prefix"}},
    {"level": 0, "id": "create", "bridge": "{ klass: after[0], ...next(operator) }", "selector": {"type": "prefix"}},
    {"level": 1, "id": "create", "bridge": "{ action: 'create', marker: 'create', klass: operator.klass }"},
    {"level": 0, "id": "destroy", "bridge": "{ name: after[0], ...next(operator) }"},
    {"level": 1, "id": "destroy", "bridge": "{ action: 'destroy', marker: 'destroy', name: operator.name }"},
    {"level": 0, "id": "call", "bridge": "{ ...next(operator), thing: after[0], name: after[1] }"},
    {"level": 1, "id": "call", "bridge": "{ marker: 'alias', thing: operator.thing, name: operator.name }"},
    {"level": 0, "id": "vers", "bridge": "{ ...next(operator), after: after[0], language: 'french' }"},
    {"level": 0, "id": "aFrench", "bridge": "{ ...next(operator), destination: after[0] }"},
    {"level": 1, "id": "aFrench", "bridge": "{ ...next(operator), thing: before[0] }"},
    {"level": 0, "id": "deplacez", "bridge": "{ ...squish(after), thing: after[0], ...next(operator), language: 'french' }"},
    {"level": 1, "id": "deplacez", "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.vers }"},
    {"level": 0, "id": "bougez", "bridge": "{ place: after[0].destination, thing: after[0].thing, ...next(operator) }"},
    {"level": 1, "id": "bougez", "bridge": "{ action: 'move', marker: 'move', thing: operator.thing, place: operator.place }"},
    {"level": 0, "id": "appellez", "bridge": "{ ...next(operator), thing: after[0], name: after[1] }"},
    {"level": 1, "id": "appellez", "bridge": "{ marker: 'alias', thing: operator.thing, name: operator.name }"},
    {"level": 0, "id": "arreter", "bridge": "{ thing: after[0], ...next(operator) }"},
    {"level": 1, "id": "arreter", "bridge": "{ action: 'stop', marker: 'stop', thing: operator.thing }"},
    {"level": 0, "id": "detruire", "bridge": "{ name: after[0], ...next(operator) }"},
    {"level": 1, "id": "detruire", "bridge": "{ action: 'destroy', marker: 'destroy', name: operator.name }"},
    {"level": 0, "id": "anyConcept", "bridge": "{ ...next(operator) }"},
