...
module.exports = 
{
  ...
  "bridges": [
    ...
    {"id": "conj", "level": 0, "selector": {"match": "same", "left": [{"variable": "type"}], "right": [{"variable": "type"}], "passthrough": true}, "bridge": "{ ...next(operator), value: append(before, after) }"},
    {"id": "conj", "level": 1, "selector": {"match": "same", "left": [{"variable": "type"}], "passthrough": true}, "bridge": "{ ...operator, value: append(before, operator.value) }"},
